...
$kodeTransaksi = $_GET['code'];
    
$transaksi = "SELECT * FROM tbltransaksi WHERE no_transaksi = '$kodeTransaksi'";
// echo $transaksi;
$rowTransaksi = mysqli_fetch_array(mysqli_query($connect, $transaksi));
...
if(isset($_POST['submit'])){  
    ...
    $pickup = $_POST['pickup'];
    $return = $_POST['return'];
    $kodeMobil = $_POST['code'];  
    
    $updatektp = "UPDATE tbltransaksi SET 
    tgl_pinjam = '$pickup',
    tgl_kembali = '$return',
    kode_mobil = '$kodeMobil',
    no_ktp_pelanggan = '$querynoktp[no_ktp_pelanggan]'
    WHERE no_transaksi = '$kodeTransaksi'"
    ;
    echo $updatektp;
    mysqli_query($connect, $updatektp); 

    echo "<meta http-equiv=refresh content=0;URL='transaction.php?code=$kodeTransaksi'>";
} 
    ...
    <!-- ***** Header Area End ***** -->
        ...
        <div class="main-banner" id="top">
            ...
            <div class="video-overlay header-text">
                <form action="<?php echo "transaksi_update.php?code=$kodeTransaksi" ?>" method="POST">
                    ...
                    <div class="reserve">
                        ...
                        <div class="formulir">
                            <div class="pickup">
                                <p>Pick-Up Date</p>
                                <div class="code">
                                    <input  type="date" name="pickup" value="<?php echo $rowTransaksi['tgl_pinjam'] ?>"> 
                                </div> 
                            </div>
                            <div class="return">
                                <p>Return Date</p>
                                <div class="code">
                                    <input  type="date" name="return" value="<?php echo $rowTransaksi['tgl_kembali'] ?>"> 
                                </div> 
                            </div>
                            ...
                            <div class="vehi-code">
                                <p>Vehicle Code</p>
                                <div class="code">
                                    <input  type="text" name="code" value="<?php echo $rowTransaksi['kode_mobil'] ?>">
                                </div>
                            </div>
